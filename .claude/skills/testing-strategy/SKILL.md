...
| E2E | Playwright (chromium) against MOCK | IT happy path through DiffView · BE happy path · broken preset shows findings + highlights · persona switch shows inbox item · cURL copy | `make e2e` |
